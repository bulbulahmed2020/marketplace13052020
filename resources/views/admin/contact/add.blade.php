            ...
            <div class="row">
                ...
                @endif
                    ...
                    <div class="content_box">
                        <form class="form-horizontal" action="{{route('admin::savePage')}}" method="post">
                           @csrf
                            <div class="form_row">
                                <div class="col span_1_of_5"><label>Page Name</label></div>
                                <div class="col span_4_of_5"><input name="page_name" type="text"></div>
                            </div>
                            <div class="form_row">
                                <div class="col span_1_of_5"><label>Content</label></div>
                                <div class="col span_4_of_5"><textarea name="page_content" cols="" rows=""></textarea></div>
                            </div>
                            <div class="form_row">
                            ...
                            <div class="form_row">
                                ...
                                <div class="col span_4_of_5"><input name="page_meta_title" type="text"></div>
                            </div>
                            <div class="form_row">
                                <div class="col span_1_of_5"><label>Meta Keyword</label></div>
                                <div class="col span_4_of_5"><textarea name="page_meta_keyword" cols="" rows=""></textarea></div>
                            </div>
                            <div class="form_row">
                                <div class="col span_1_of_5"><label>Meta Description</label></div>
                                <div class="col span_4_of_5"><textarea name="page_meta_description" cols="" rows=""></textarea></div>
                            </div>
                            <div class="form_row">
